...
\begin{table}[h!]
	...
	Potentially more descriptive information payload.&May utilise broadcast protocols.\\
	\end{tabular}
	\end{center}
...
\begin{table}[h!]
	...
	Simple&Minimal information payload\\
	\end{tabular}
	\end{center}
...
\begin{table}[h!]
	...
	LDAP&Lightweight Directory Access Protocol (LDAP) is used for accessing and maintaining distributed directory information services over an Internet Protocol (IP) network.\\
	\end{tabular}
	\end{center}
	\label{Pulse Meter Option}
\end{table}
...
\begin{itemize}
\item All inter-networking communications managed from a single endpoint;
\item Lightweight telemetry;
\item No packet loss, even through interruptions to network connectivity.
\end{itemize}
...
https://mqtts.hoshi.property only accepts telemetry that strictly follows the schema:\\
